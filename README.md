...
Its an Enquiry & Schedule Manager full-stack application built with Next.js + TypeScript on the frontend and Node.js + JavaScript on the backend, using Prisma ORM with PostgreSQL for database management.
